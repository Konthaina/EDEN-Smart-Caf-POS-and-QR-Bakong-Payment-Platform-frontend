<template>
  <AppLayout>
    <div class="p-6 space-y-6">
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex gap-3 items-center">
          ...
          <button
            ...
            class="flex items-center gap-2 px-3 py-1.5 rounded-full shadow-inner transition-all text-sm font-semibold bg-white text-gray-800 border-gray-300 dark:bg-gray-800 dark:text-white dark:border-gray-600"
          >
            <img
      ...
      <div
        v-if="loading"
        class="animate-pulse bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 grid grid-cols-1 md:grid-cols-2 gap-10"
      >
        <div
      ...
      <div
        v-else
        class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 grid grid-cols-1 md:grid-cols-2 gap-10"
      >
        <!-- Profile Summary -->
        <div
